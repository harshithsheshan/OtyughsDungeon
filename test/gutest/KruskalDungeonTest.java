...
public class KruskalDungeonTest {
  ...
  /**
   * To test pit was added.
   */
  @Test
  public void testPit() {
    Assert.assertTrue(d.pitAdded());
  }

  @Test
  public void testThiefAdded() {
    Assert.assertTrue(d.thiefAdded());
  }

  @Test
  public void testNinjaAdded() {
    Assert.assertTrue(d.ninjaAdded());
  }

  @Test
  public void testNinjaMovesRandom() {
    Assert.assertTrue(d.ninjaMovable());
  }
}